...
import com.cuppytrail.constants.CuppytrailConstants;



/**
 * This is the extension manager of the Cuppytrail extension.
 */
public class CuppytrailManager extends GeneratedCuppytrailManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CuppytrailManager.class.getName());
	 ...
	 */
	public static CuppytrailManager getInstance()
	{
		return (CuppytrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CuppytrailConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CuppytrailManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CuppytrailManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CuppytrailManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CuppytrailManager called, current tenant: " + getTenant().getTenantID());
		}
	}
